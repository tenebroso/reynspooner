...
function dcwss_networks($a)
{
	...
	$defaults['facebook'] = Array('id' => '', 'intro' => 'Posted', 'comments' => '3', 'image_width' => '6', 'thumb' => 'true', 'out' => 'intro,thumb,title,text,user,share', 'text' => 'contentSnippet');
