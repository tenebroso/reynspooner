...
if(!class_exists('dcwp_plugin_admin_dcwss')) {
	...
	class dcwp_plugin_admin_dcwss {
		...
		function add_admin_styles() {
			...
			wp_enqueue_style("dcwss_admin_css", dc_jqsocialstream::get_plugin_directory(). "/css/dcwss_admin.css");
		...
		function add_admin_scripts() {
			...
			wp_enqueue_script('dcwss_jquery_admin', dc_jqsocialstream::get_plugin_directory(). '/inc/js/jquery.dcwss.admin.js');
