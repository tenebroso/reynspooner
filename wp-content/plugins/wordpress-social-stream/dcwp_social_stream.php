...
class dc_jqsocialstream {
	...
	function add_dcwss_styles() {
		...
		if(get_dcwss_default('skin') == 'true' || get_dcwss_default('skin') == ''){
			wp_enqueue_style( 'dcwss', dc_jqsocialstream::get_plugin_directory() . '/css/dcwss.css');
		}
	...
	function add_dcwss_scripts() {
		...
		wp_enqueue_script( 'dcwss-wall', dc_jqsocialstream::get_plugin_directory() . '/js/jquery.social.stream.wall.1.5.js' );
		wp_enqueue_script( 'dcwss', dc_jqsocialstream::get_plugin_directory() . '/js/jquery.social.stream.1.5.7.min.js' );
